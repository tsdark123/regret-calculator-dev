...
export function TestimonialCard({
  ...
  return (
    <motion.div
      ...
      className={`absolute left-0 top-0 grid h-[360px] w-[280px] sm:h-[450px] sm:w-[350px] select-none place-content-center space-y-5 sm:space-y-6 rounded-2xl border-2 border-[var(--border)] bg-[var(--bg-card)]/90 p-5 sm:p-6 shadow-xl backdrop-blur-md ${
