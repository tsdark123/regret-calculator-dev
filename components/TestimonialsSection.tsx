...
export const TestimonialsSection: React.FC = () => (
  <section className="w-full pt-2 pb-4 md:pt-4 md:pb-8 select-none flex flex-col items-center">
    <div className="relative z-10 text-center mb-6 md:mb-10 flex flex-col items-center gap-2 mt-2 md:mt-0 px-4">
