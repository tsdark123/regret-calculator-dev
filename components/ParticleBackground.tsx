        ...
        switch (theme) {
            case 'green':
                return {
                    ...
                    triangle: 'rgba(34, 197, 94, 0.06)',
                };
            case 'blue':
                return {
                    particle: 'rgba(59, 130, 246, 0.4)',
                    link: 'rgba(59, 130, 246, 0.25)',
                    triangle: 'rgba(59, 130, 246, 0.06)',
                };
            case 'purple':
            default:
                return {
                    ...
                    if (dist12 < linkDistance) {
                        ...
                        for (let k = j + 1; k < particles.length; k++) {
                            ...
                            if (dist13 < linkDistance && dist23 < linkDistance) {
                                ...
                                ctx.closePath();
                                ctx.fillStyle = colors.triangle.replace('0.06', (0.06 * avgOpacity).toFixed(3));
                                ctx.fill();
                            }
                        }
